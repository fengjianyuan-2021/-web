...
import { CustomersStudentTable } from '@/components/dashboardStudent/customerStudent/customersStudent-table';
    ...
    <Stack spacing={3}>
      <Stack direction="row" spacing={3}>
        <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
          <Typography variant="h4">学生干部信息查询</Typography>
        </Stack>
      </Stack>
      <CustomersStudentTable
