...
export default function Page(): React.JSX.Element {
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid lg={3} sm={6} xs={12}>
        <EvaluatedStudentCount sx={{ height: '100%' }} value={parseInt(dashboardTeacher?.evaluatedStudentCount ?? "0",10)} EvaluationType='学生评价' valuePercentage={parseInt(dashboardTeacher?.evaluatedStudentPercentage ?? "0",10)} />
      </Grid>
      <Grid lg={3} sm={6} xs={12}>
        <UnevaluatedStudentCount sx={{ height: '100%' }} value={parseInt(dashboardTeacher?.unevaluatedStudentCount ?? "0",10)} EvaluationType='学生评价' valuePercentage={parseInt(dashboardTeacher?.unevaluatedStudentPercentage ?? "0",10)} />
      </Grid>
      <Grid lg={3} sm={6} xs={12}>
